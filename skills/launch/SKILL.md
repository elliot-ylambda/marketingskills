---
name: launch
description: "Plan product launches and feature announcements — ORB channel framework, five phases from alpha to GA, waitlists, Product Hunt strategy."
metadata:
  version: 2.0.1
---

# Launch Strategy
Related Skills: add 'offers — for the offer being launched (bonuses, guarantees, scarcity, naming)'; pointer existed only in the old description.
