...
description: "Create sales collateral — pitch decks, one-pagers, objection docs, demo scripts, ROI calculators, playbooks, buyer persona cards."
metadata:
  version: 2.0.1
---

# Sales Enablement
Related Skills: add 'offers — for the offer being sold (bonuses, guarantees, pricing structure)'; pointer existed only in the old description.
