...
description: "Build SEO pages at scale from templates and data (pSEO) — location, comparison, integration, glossary playbooks; avoid thin content."
metadata:
  version: 2.0.0
---

# Programmatic SEO
Related Skills: add 'content-strategy — for content strategy planning'; this routing pointer existed only in the old description.
