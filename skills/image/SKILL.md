---
name: image
description: "Create and optimize marketing images — AI generation (Nano Banana, Flux, Ideogram), Canva/Figma, banners, OG images, WebP optimization."
metadata:
  version: 2.0.2
---
...
# Page-level image discovery requires the typed magister-firecrawl read action.
# Inspect image src/srcset attributes in its rendered-HTML result.
```
